  ...
  return (
    <div className="footer__main__wrapper">
      ...
      <div className="copyright__footer">
        <h6 className="copyright__txt">
          {" "}
          Copyright © 2021-2022 By Isoqjon Osimjonov .All rights reserved.
        </h6>
      </div>
      ...
      <div className="footer__media__links">
        <a href="http://www.google.com">
          {" "}
          <RiTelegramLine className="footer__media__icons" />{" "}
        </a>
        <a href="http://www.google.com">
          {" "}
          <RiInstagramLine className="footer__media__icons" />{" "}
        </a>
        <a href="http://www.google.com">
          {" "}
          <RiFacebookCircleLine className="footer__media__icons" />{" "}
        </a>
      </div>
